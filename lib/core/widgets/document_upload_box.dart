      ...
      children: [
        ...
        GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            height: _file != null ? 160 : 110,
            decoration: BoxDecoration(
              color: fillColor,
              borderRadius: BorderRadius.circular(AppRadius.medium),
              border: Border.all(color: borderColor, width: 1.5),
            ),
            child: _file == null ? _placeholder(cs) : _preview(cs),
          ),
        ),
      ],
    );
    ...
    return Column(
      ...
      children: [
        Container(
          ...
          child: Icon(Icons.upload_file, color: cs.primary, size: 28),
        ),
        const SizedBox(height: 8),
        Text(
          widget.hint,
